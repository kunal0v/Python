...
print(st.replace("kunal","Ramesh"))

#   name.find(word)---> it will print the first character index of the word
print(st.find("kunal"))

#   name.count("o") ----> Tells about the no. of times o character was found
print(st.count("o"))                                                             